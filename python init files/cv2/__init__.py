# encoding: utf-8
# module cv2
# from /usr/local/lib/python2.7/dist-packages/cv2.so
# by generator 1.144
# no doc

# imports
import cv2 as  # /usr/local/lib/python2.7/dist-packages/cv2.so
import cv2.aruco as aruco # <module 'cv2.aruco' (built-in)>
import cv2.instr as instr # <module 'cv2.instr' (built-in)>
import cv2.dnn as dnn # <module 'cv2.dnn' (built-in)>
import cv2.ximgproc as ximgproc # <module 'cv2.ximgproc' (built-in)>
import cv2.fisheye as fisheye # <module 'cv2.fisheye' (built-in)>
import cv2.ocl as ocl # <module 'cv2.ocl' (built-in)>
import cv2.saliency as saliency # <module 'cv2.saliency' (built-in)>
import cv2.videostab as videostab # <module 'cv2.videostab' (built-in)>
import cv2.plot as plot # <module 'cv2.plot' (built-in)>
import cv2.xfeatures2d as xfeatures2d # <module 'cv2.xfeatures2d' (built-in)>
import cv2.text as text # <module 'cv2.text' (built-in)>
import cv2.ml as ml # <module 'cv2.ml' (built-in)>
import cv2.motempl as motempl # <module 'cv2.motempl' (built-in)>
import cv2.flann as flann # <module 'cv2.flann' (built-in)>
import cv2.bgsegm as bgsegm # <module 'cv2.bgsegm' (built-in)>
import cv2.bioinspired as bioinspired # <module 'cv2.bioinspired' (built-in)>
import cv2.cuda as cuda # <module 'cv2.cuda' (built-in)>
import cv2.Error as Error # <module 'cv2.Error' (built-in)>
import cv2.datasets as datasets # <module 'cv2.datasets' (built-in)>
import cv2.structured_light as structured_light # <module 'cv2.structured_light' (built-in)>
import cv2.rgbd as rgbd # <module 'cv2.rgbd' (built-in)>
import cv2.multicalib as multicalib # <module 'cv2.multicalib' (built-in)>
import cv2.ft as ft # <module 'cv2.ft' (built-in)>
import cv2.xphoto as xphoto # <module 'cv2.xphoto' (built-in)>
import cv2.line_descriptor as line_descriptor # <module 'cv2.line_descriptor' (built-in)>
import cv2.ogl as ogl # <module 'cv2.ogl' (built-in)>
import cv2.face as face # <module 'cv2.face' (built-in)>
import cv2.ppf_match_3d as ppf_match_3d # <module 'cv2.ppf_match_3d' (built-in)>
import cv2.detail as detail # <module 'cv2.detail' (built-in)>
import cv2.optflow as optflow # <module 'cv2.optflow' (built-in)>
import cv2.omnidir as omnidir # <module 'cv2.omnidir' (built-in)>
